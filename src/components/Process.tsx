  ...
  return (
    <section id="quy-trinh" className="py-10 sm:py-14 bg-white">
      <div className="w-full max-w-[1300px] mx-auto px-5 sm:px-8">
        ...
        <div className="flex gap-4 overflow-x-auto snap-x snap-mandatory pb-2 sm:grid sm:grid-cols-2 lg:grid-cols-4 sm:gap-6 sm:overflow-visible max-w-4xl mx-auto" style={{ scrollbarWidth: "none" }}>
          {STEPS.map((step, i) => (
            <div key={step.num} className="shrink-0 w-[200px] sm:w-auto snap-start relative text-center">
              {/* Connector */}
              {i < STEPS.length - 1 && (
                <div className="hidden lg:block absolute top-9 left-[60%] w-[80%] border-t border-dashed border-zinc-200" />
              )}
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <h3 className="text-sm sm:text-[15px] font-semibold text-zinc-900 mb-2">
                  {step.title}
                </h3>
